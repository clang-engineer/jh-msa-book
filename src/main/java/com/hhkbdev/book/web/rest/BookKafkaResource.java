...
public class BookKafkaResource {
    ...
    private final Logger log = LoggerFactory.getLogger(BookKafkaResource.class);
    ...
    public BookKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
