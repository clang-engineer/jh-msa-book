package com.hhkbdev.book.web.rest;
...
import com.hhkbdev.book.IntegrationTest;
import com.hhkbdev.book.domain.Book;
import com.hhkbdev.book.repository.BookRepository;
import com.hhkbdev.book.service.criteria.BookCriteria;
import com.hhkbdev.book.service.dto.BookDTO;
import com.hhkbdev.book.service.mapper.BookMapper;
...
class BookResourceIT {
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
        return book;
    }
    ...
    void putExistingBook() throws Exception {
        ...
        updatedBook.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
